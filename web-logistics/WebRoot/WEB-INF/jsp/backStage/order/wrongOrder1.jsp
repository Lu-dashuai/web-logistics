...
<body>
	<table id="tt" class="easyui-datagrid" title="异常单列表" style="width:100%;height:100%;"
		...
		data-options="singleSelect:true,collapsible:true,url:'wrong/page.do?wrongorder_satus=1',method:'post'">
		<thead>
			<tr>
	...
	<div id="dlg" class="easyui-dialog" style="width:400px;height:280px;padding:10px 20px"
		closed="true"  buttons="#dlg-buttons">
			...
			<form id="fm" method="post">
				...
				<div class="fitem">
					<label>发货人姓名：</label>
					<input name="sender_name" class="easyui-validatebox" required="true" onfocus="this.blur()">
				</div>
				<div class="fitem">
					<label>发货人电话:</label>
				...
				<div class="fitem">
					<label>赔付金额:</label>
					<input name="badpay" class="easyui-validatebox" >
				</div>
			</form>
	</div>
	<!-- 添加页面的保存按钮 -->		
