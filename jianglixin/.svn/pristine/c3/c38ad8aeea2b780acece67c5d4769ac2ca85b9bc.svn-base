...
<script type="text/javascript" src="/lightning3/before/wangjia/showWorkerlimit/showWorker.js"></script>
...
<body>
	...
	<div id="toolbar">
		<div class="btn-group">
			<a href="/lightning3/before/wangjia/insertWorker.jsp"><button type="button" class="btn btn-primary" id="addBtn">增加</button></a>
...
<!-- 					<h4 class="modal-title" id="myModalLabel">模态框（Modal）标题</h4> -->
					...
					<!-- <h4 class="modal-title" id="myModalLabel">员工信息录入</h4>
