...
INSERT INTO `account` VALUES ('7', '500.80');
...
CREATE TABLE `bills` (
  ...
  `bills_users` varchar(255) DEFAULT NULL COMMENT '用户id',
  `bills_shape` int(255) DEFAULT NULL COMMENT '用户删除订单的状态',
  PRIMARY KEY (`bills_indent`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `bills` VALUES ('7', 'aaa555', '1');
...
CREATE TABLE `car` (
  ...
  `car_code` varchar(255) NOT NULL COMMENT '车牌',
...
CREATE TABLE `cargo` (
  ...
  `cargo_explain` text COMMENT '货物备注',
...
INSERT INTO `cargo` VALUES ('7', '2.00', '4.00', '1', '水果');
...
CREATE TABLE `cartype` (
  `cartype_id` int(255) NOT NULL AUTO_INCREMENT COMMENT '车辆类型id',
  `cartype_name` varchar(255) NOT NULL COMMENT '车辆类型名称',
...
-- Records of comego
-- ----------------------------
INSERT INTO `comego` VALUES ('1', '1', '2018-05-18', '1', null);
INSERT INTO `comego` VALUES ('2', '4', '2018-05-18', '2', null);
INSERT INTO `comego` VALUES ('3', '7', '2018-05-29', '1', null);
...
CREATE TABLE `comein` (
  ...
  PRIMARY KEY (`comein_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of comein
-- ----------------------------
INSERT INTO `comein` VALUES ('1', '1', '2018-05-18', '1');
INSERT INTO `comein` VALUES ('2', '2', '2018-05-18', '1');
INSERT INTO `comein` VALUES ('3', '4', '2018-05-18', '2');
INSERT INTO `comein` VALUES ('4', '5', '2018-05-18', '2');
INSERT INTO `comein` VALUES ('5', '7', '2018-05-29', '1');
...
CREATE TABLE `company` (
  ...
  `company_introduce` text COMMENT '公司简介',
...
CREATE TABLE `indent` (
  ...
  `indent_receiver_name` varchar(255) NOT NULL COMMENT '收货人姓名',
  `indent_receiver_phone` bigint(11) NOT NULL COMMENT '收货人手机号',
  `indent_receiver_postcode` int(6) NOT NULL COMMENT '收货人邮编',
  `indent_receiver_address` varchar(255) NOT NULL COMMENT '收货人地址',
  `indent_shipper_name` varchar(255) NOT NULL COMMENT '发货人姓名',
  `indent_shipper_phone` bigint(11) NOT NULL COMMENT '发货人手机号',
  `indent_shipper_postcode` int(6) NOT NULL COMMENT '发货人邮编',
  `indent_shipper_address` varchar(255) NOT NULL COMMENT '发货人地址',
  `indent_situation` int(20) NOT NULL COMMENT '订单状态',
...
-- Records of indent
-- ----------------------------
INSERT INTO `indent` VALUES ('1', '2018-05-18', '李亚宁', '13838458751', '451150', '2', '王俊凯', '13838457862', '451100', '1', '1');
INSERT INTO `indent` VALUES ('2', '2018-05-18', '梁定祥', '13884568759', '451150', '2', '李富华', '13838457862', '451100', '1', '2');
INSERT INTO `indent` VALUES ('3', '2018-05-19', '于海洋', '13818555545', '451150', '2', '贺文龙', '13838457862', '451100', '1', '3');
INSERT INTO `indent` VALUES ('4', '2018-05-19', '李志敏', '13818555545', '451150', '1', '吴倩', '13838457862', '451100', '2', '1');
INSERT INTO `indent` VALUES ('5', '2018-05-20', '王雨露', '13838458751', '458525', '1', '刘雪', '13838457862', '451100', '2', '2');
INSERT INTO `indent` VALUES ('6', '2018-05-20', '姜泽华', '13838458751', '451150', '1', '赵枝', '13838457862', '451100', '2', '3');
INSERT INTO `indent` VALUES ('7', '2018-05-29', '于海洋', '18336397221', '450000', '2', '李亚宁', '13838457862', '451100', '1', '1');
...
CREATE TABLE `keeper` (
  ...
  PRIMARY KEY (`keeper_worker`,`keeper_warehose`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `post` (
  ...
  `post_name` varchar(255) DEFAULT NULL COMMENT '职位名字',
...
CREATE TABLE `power` (
  ...
  `power_type` varchar(255) DEFAULT NULL COMMENT '权限类型',
...
CREATE TABLE `price` (
  ...
  `price_explain` varchar(255) DEFAULT NULL COMMENT '价格说明填写栏',
...
CREATE TABLE `situation` (
  ...
  `situation_name` varchar(255) NOT NULL COMMENT '状态名称',
...
CREATE TABLE `state` (
  ...
  `state_name` varchar(255) DEFAULT NULL COMMENT '车辆状态信息',
...
CREATE TABLE `station` (
  ...
  `station_name` varchar(255) NOT NULL COMMENT '网点名字',
  `station_address` varchar(255) NOT NULL COMMENT '网点具体地址',
...
CREATE TABLE `status` (
  ...
  `status_name` varchar(255) DEFAULT NULL COMMENT '状态信息',
...
CREATE TABLE `time` (
  ...
  `time_car_id` int(255) NOT NULL COMMENT '车辆id',
  `time_start` datetime NOT NULL COMMENT 'type_id',
  `time_end` datetime DEFAULT NULL COMMENT '所属网点',
  `time_date` int(255) NOT NULL COMMENT '运输时间',
  PRIMARY KEY (`time_id`)
...
-- Records of time
-- ----------------------------
INSERT INTO `time` VALUES ('1', '1', '2018-03-21 20:12:14', '2018-03-22 20:19:13', '1');
...
CREATE TABLE `type` (
  ...
  `type` char(40) DEFAULT NULL COMMENT '类别（货物）',
...
CREATE TABLE `users` (
  `users_id` varchar(18) NOT NULL COMMENT '用户id(账号)',
  `users_password` varchar(255) NOT NULL COMMENT '用户密码',
  `users_name` varchar(255) NOT NULL COMMENT '姓名',
  `users_phone` varchar(255) NOT NULL COMMENT '用户电话',
  `users_idcard` varchar(255) NOT NULL COMMENT '用户身份正号码',
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('aaa555', 'aaa555', '李亚宁', '13838457862', '41018419980101555x', '451100');
INSERT INTO `users` VALUES ('aaa666', 'aaa666', '于海洋', '18336397221', '410725199611026558', '453500');
...
CREATE TABLE `worker` (
  ...
  `worker_name` varchar(255) NOT NULL COMMENT '员工名字',
  `worker_idcard` varchar(255) NOT NULL COMMENT '员工身份证',
