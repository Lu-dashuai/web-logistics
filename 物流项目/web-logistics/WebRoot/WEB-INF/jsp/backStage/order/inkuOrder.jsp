...
<script type="text/javascript" src="easyui/jquery.easyui.min.js"></script>
				...
				// alert(order_ids);
				 $.messager.confirm('Confirm','确认通过吗?',function(r){
					if (r){
					   ...
					   //alert("111");
						$.post('order/inkuOrder.do',{idsStr:idsStr},function(result){
							//alert(result);
							if (result.suc=='true'){
							  //  alert(1111);
  ...
  <body>
    ...
    <table id="tt" class="easyui-datagrid" title="订单审核"
		...
		data-options="singleSelect:false,collapsible:true,url:'order/page.do?status2=2&overStore0=0',method:'get'">
		<thead>
			<tr>
	...
	<div id="tb" style="padding:3px">
		<a class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="inkuOrder()">入库</a>
	</div>
