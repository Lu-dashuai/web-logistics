...
<script type="text/javascript" src="easyui/jquery.easyui.min.js"></script>
  ...
  <body>
     <table id="tt" class="easyui-datagrid"   title="员工信息列表列表" style="width:100%; "
			pagination="true" fitColumns="true" toolbar="#tb" iconCls="icon-more"  	data-options="singleSelect:true,collapsible:true,url:'emp/page.do',method:'post'">
			<thead>
				<tr>
					<th data-options="field:'id',width:80,align:'center',sortable:true"  >序号</th>
					<th data-options="field:'ename',width:100,align:'center'" sortable="true">名字</th>
					<th data-options="field:'sex',width:80,align:'center'">性别</th>
					<th data-options="field:'tel',width:80,align:'center'" sortable="true">电话</th>
					<th data-options="field:'dept',width:250,align:'center'">部门</th>
					<th data-options="field:'duties',width:60,align:'center'">职位</th>
					<th data-options="field:'username',width:60,align:'center'">用户名</th>
					<th data-options="field:'hiredate',width:60,align:'center'">入职时间</th>
					<th data-options="field:'state',width:60,align:'center'">员工状态</th>
					<th data-options="field:'store',width:60,align:'center'">所属门店</th>
					<th data-options="field:'roleId',width:60,align:'center'" formatter="formatRole">角色</th>
					<th data-options="field:'password',width:60,align:'center'" >账户密码</th>
				</tr>
			</thead>
		</table>
		<!--搜素，添加 ，删除，查询  -->
		...
		closed="true"  buttons="#dlg-buttons">
			...
			<form id="fm" method="post">
				...
				<div class="fitem">
					<label>部门:</label>
					<input name="dept" class="easyui-validatebox"  >
				</div>
				<div class="fitem">
					<label>职位:</label>
					<input name="duties" class="easyui-validatebox" >
				</div>
				<div class="fitem">
					<label>用户名:</label>
				...
				<div class="fitem">
					<label>入职时间:</label>
					<input class="easyui-datebox" name="hiredate"  >
				</div>
				<div class="fitem">
					<label>员工状态:</label>
					<input name="state" class="easyui-validatebox" >
				</div>
				<div class="fitem">
					<label>所属门店:</label>
