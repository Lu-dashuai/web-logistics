...
<html>
  ...
  <body class="easyui-layout">
	...
	%>
  	<div data-options="region:'north',border:false" style="height:80px;background:#98FB98;padding:2px" >
  		<div>
  			<table>
  				<tr>
  					<td>用户名：</td>
  ...
  <!-- 左边框 -->
	<div data-options="region:'west',split:true,title:'功能菜单'" style="width:220px;padding:10px;">
		  <div class="easyui-panel" style="padding:5px">
				  <ul id="tt" class="easyui-tree" data-options="url:'power/powerTree.do',method:'get',animate:true"></ul>
		  </div>
    </div>
