		...
		<div class="login-wrap">
			<form action="admin/ifLogin.do" method="post">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
			    ...
			    <tr>
			      <td><input type="text" class="login_input login_user"  style="width: 220px"  name="username"/></td>
			    </tr>
			    <tr>
			      <td height="35" valign="bottom" >密  码：</td>
			    </tr>
			    <tr>
			      <td><input type="password"  class="login_input login_user" style="width: 220px" name="password"/></td>
			    </tr>
			    <tr>
			    	
			      <td height="60" valign="bottom"><input type="submit" class="btn btn-block btn-login" value="登陆"/></td>
			    </tr>
			  </table>
		  </form>
		</div>
		<div class="copyright">建议使用火狐浏览器</div>
  </body>
</html>
