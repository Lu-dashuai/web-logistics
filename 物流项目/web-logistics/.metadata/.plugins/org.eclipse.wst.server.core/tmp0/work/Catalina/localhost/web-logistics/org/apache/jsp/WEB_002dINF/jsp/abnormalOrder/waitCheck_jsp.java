 ...
 * Generated at: 2019-05-23 07:25:06 UTC
...
public final class waitCheck_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("  \r\n");
      out.write("  <body>\r\n");
      out.write("    <table id=\"tt\"  class=\"easyui-datagrid\" title=\"待审核订单信息\" style=\"width:100%;height:100%\"\r\n");
      out.write("\t\tpagination=\"true\" fitColumns=\"true\" toolbar=\"#tb\" rownumbers=\"true\" data-options=\"singleSelect:true,collapsible:true,\r\n");
      out.write("\t\turl:'bad/allBadOrder.do?state='+0,method:'post'\">\r\n");
      out.write("\t\t<thead>\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t<th data-options=\"field:'badorder_reason',width:60,align:'center'\" formatter=\"formatBadorder_reason\">异常信息</th>\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t<div id=\"dlg\" class=\"easyui-dialog\" style=\"width:400px;height:300px;left: 600px;top:300px\"\r\n");
      out.write("\t\tclosed=\"true\"  buttons=\"#dlg-buttons\">\r\n");
      out.write("\t\t<form id=\"ff\" method=\"post\">\r\n");
      out.write("\t\t\t\t<div class=\"fitem\">\r\n");
      out.write("\t\t\t\t\t<label>异常信息:</label> \r\n");
      out.write("\t\t\t\t\t  <input  name=\"badorder_reason\" class=\"easyui-validatebox\" readonly=\"readonly\">\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"fitem\">\r\n");
      out.write("\t\t\t\t\t<label>员工回执:</label>\r\n");
      out.write("\t\t\t\t <input  name=\"add2_reason\" class=\"easyui-validatebox\" readonly=\"readonly\"> \r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"fitem\">\r\n");
      out.write("\t\t\t\t\t<label>复核意见:</label>\r\n");
      out.write("\t\t\t\t <input  name=\"back2_reason\" class=\"easyui-validatebox\" readonly=\"readonly\"> \r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div id=\"dlg-buttons\">\r\n");
      out.write("\t\t\t<a  class=\"easyui-linkbutton\" iconCls=\"icon-cancel\" onclick=\"javascript:$('#dlg').dialog('close')\">关闭</a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t<div id=\"dlgg\" class=\"easyui-dialog\" style=\"width:400px;height:300px;padding:10px 5px\"\r\n");
      out.write("\t\tclosed=\"true\"  buttons=\"#dlgg-buttons\">\r\n");
      out.write("\t\t<form id=\"fm\" method=\"post\">\r\n");
      out.write("\t\t\t\t<div class=\"fitem\">\r\n");
      out.write("\t\t\t\t\t<label>建议赔偿金额:</label> <br>\r\n");
      out.write("\t\t\t\t\t  <input  name=\"advise_money\" class=\"easyui-validatebox\" required=\"true\">\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"fitem\">\r\n");
      out.write("\t\t\t\t\t<label>原因:</label><br>\r\n");
      out.write("\t\t\t\t <textarea name=\"emp_details\" style=\"width:200px;height:80px;\" class=\"easyui-validatebox\" required=\"true\"></textarea>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t\treturn '<input id=\"bh\"  type=\"button\"  value=\"驳回\" onclick=\"reject(\\''+row.badorder_id+'\\')\">|<input  id=\"tg\" type=\"button\"  value=\"通过\" onclick=\"pass(\\''+row.badorder_id+'\\')\"></input>';\r\n");
      out.write("\t\r\n");
      out.write("\t}\r\n");
      out.write("\t//查看详情\r\n");
      out.write("\tfunction formatBadorder_reason(val,row,index){\r\n");
      out.write("\t\t //var rows = JSON.stringify(row);\r\n");
      out.write("\t\r\n");
      out.write("\t\treturn '<input id=\"ckxq\"  type=\"button\"  value=\"查看详情\" onclick=\"showDetails(\\''+row.badorder_id+'\\')\">';\r\n");
      out.write("\t\r\n");
      out.write("\t}\r\n");
      out.write("\t//显示订单是否保价\r\n");
      ...
      out.write("\t\t }\r\n");
      out.write("\t\t //查看详情\r\n");
      out.write("\t\t function showDetails(data){\r\n");
      out.write("\t\t \t$('#ff').form('load',\"bad/getAllBad.do?badorder_id=\"+data);\r\n");
      out.write("\t\t \t$('#dlg').dialog('open').dialog('setTitle','通知信息');\r\n");
      out.write("\t\t }\r\n");
      out.write("\t\t //驳回\r\n");
      out.write("\t\t function reject(id){\r\n");
      out.write("\t\t\t$('#dlgg').window('center');\r\n");
      out.write("\t\t\t$('#dlgg').dialog('open').dialog('setTitle','驳回意见');\r\n");
      out.write("\t\t\t$('#fm').form('clear');\r\n");
      out.write("\t\t\turl = \"bad/update.do?badorder_id=\"+id+\"&val=\"+1;\r\n");
      out.write("\t\t} \r\n");
      out.write("\t\t//通过\r\n");
      out.write("\t\tfunction pass(id){\r\n");
      out.write("\t\t\t\t$.messager.confirm('Confirm','确定要通过吗?',function(r){\r\n");
      out.write("\t\t\t\t\tif (r){\r\n");
      out.write("\t\t\t\t\t //jquery的ajax操作  $.get(地址，参数，回调函数，返回值类型)\r\n");
      out.write("\t\t\t\t\t   //  $.post(地址，参数，回调函数，返回值类型)\r\n");
      out.write("\t\t\t\t\t\t$.post('bad/update.do',{badorder_id:id,val:2 },function(result){\r\n");
